...
public class Product {
	...
	public Product(int productNumber, String productTitle, int productPrice, String productText, String productName,
			String productPictureNameURL, int productCount, Date productDate, int memberNumber, int categoryNumber) {
