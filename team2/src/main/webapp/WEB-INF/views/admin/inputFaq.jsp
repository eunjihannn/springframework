            ...
            <div id="tbl">
               ...
               <div class="box">
                ...
                <div class="box">
                    ...
                    <div><input class="inputBox" type="text" name="faqTitle" id="quTitle"></div>
                </div>
                <div class="box">
                    <div class="property">공지내용</div>
                    <div><textarea class="inputBox" name="faqContent" id="quContent"></textarea></div>
                </div>
                <div class="btns">
                    <div>
