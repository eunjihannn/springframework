   ...
   <jsp:include page="../Header.jsp"/>
      <div class="community-wrap">
         <div class="content-area">
            ...
            <form action="${pageContext.request.contextPath}/community/modification/" method="POST">
            ...
            <input type="hidden" value="${BoardVO.bno}" name="bno">
               ...
               <div class="content-writer">
                  <div style="height:60px">
                     <textarea class="title-input" id="" name="title">${BoardVO.title}</textarea>
                  </div>
                  <div>
                     <textarea class="content-input" id="" name="content">${BoardVO.content}</textarea>
                  </div>
