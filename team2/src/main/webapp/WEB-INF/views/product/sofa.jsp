...
<body>
	<div class="main" id="top">
		<div class="hBar">
			<div id="title">sofa / chair</div>
			<div>
				<ul class="productUl">
					<li class="bList now"><a href="<c:url value='/product/1'/>">sofa&chair</a></li>
					<li class="bList"><a href="<c:url value='/product/2'/>">bed</a></li>
		...
		<div class="sidebar">
            <div class="btn" onclick="location.href='${pageContext.request.contextPath}/main'">main</div>
            <a id="up" href="#top"><div class="btn">top</div></a>
