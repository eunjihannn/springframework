...
<head>
    ...
    <link href="<c:url value="/resources/css/term.css"/>" rel='stylesheet' />
</head>
...
1. 본 약관은 사이트가 제공하는 모든 서비스(이하 "서비스")의 이용조건 및 절차, 이용자와 기업마당 사이트의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
제 2 조 (약관의 효력과 변경)
1. 사이트는 귀하가 본 약관 내용에 동의하는 경우 이트의 서비스 제공 행위 및 귀하의 서비스 사용 행위에 본 약관이 우선적으로 적용됩니다.
...
3. 회원 : 사이트에 개인 정보를 제공하여 회원 등록을 한 자로서 기업마당 사이트가 제공하는 서비스를 이용할 수 있는 자.
...
1. 기업마당 사이트와 이용자 간에 발생한 서비스 이용에 관한 분쟁에 대하여는 대한민국 법을 적용하며, 본 분쟁으로 인한 소는 대한민국의 법원에 제기합니다.
        ...
        <form action="signup" method="POST"> <!-- <form action="signup" method="POST"> <form:form action="signup"> </form:form> -->
        <div class="terms">
            <label for="checkTerm">
            ...
            <div>
               <span class="hide" id="message">개인정보 수집 및 이용에 대한 안내에 동의해주세요.</span>
            </div>
        </div>
        <div class="btns">
            <input class="btn" type="button" value="취소" onclick="location.href='main'">
            <input class="btn" type="submit" onclick="return error_toggle()" value="<spring:message code="next.btn"/>" />
        </div>
        </form>
    </div>
